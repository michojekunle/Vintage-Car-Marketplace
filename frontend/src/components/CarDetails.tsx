        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-8">
            ...
            <motion.div
              ...
              className="space-y-6"
            >
              <h2 className="text-4xl font-bold text-gray-800">Chevrolet Bel Air</h2>
              ...
              <div className="text-sm text-gray-600">
                ...
                <p className="flex items-center gap-1">
                  ...
                  <Verified className="text-green-500 w-4 h-4" /> {/* Updated to Verified */}
                </p>
                <p>
              ...
              <div className="space-y-2">
                <p className="text-lg font-semibold text-gray-700">Buyout Price: $30,000</p>
                <Button className="w-full bg-primary-action text-white">Buy Now</Button>
                <div className="border-t border-gray-200 pt-2">
                  <p className="text-lg font-semibold text-gray-700">Auction Ends In: 2 days 14 hrs</p>
                  <Button className="w-full bg-amber-500 text-white">Place a Bid</Button>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <section className="mt-12">
          ...
          <div className="bg-white shadow-md rounded-lg p-4">
            <p className="text-gray-700">
              Book a certified mechanic for repair or maintenance services directly through our platform.
            </p>
            <Button className="mt-4 bg-primary-action text-white">Book a Mechanic</Button>
          </div>
        </section>
      </main>
    </div>
