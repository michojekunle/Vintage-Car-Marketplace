          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="text-sm text-gray-600">
                ...
                <p className={`${isListed ? 'text-green-600 bg-green-100': 'text-amber-600 bg-amber-100'} py-1 mt-2 px-4 w-[max-content]`}>
              ...
              <div className="space-y-2">
                {!isListed ? <Button className="w-full bg-amber-500 text-white">
                  List Car for Sale
                </Button> :
