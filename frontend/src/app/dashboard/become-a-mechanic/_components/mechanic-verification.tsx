      ...
      <div className="grid md:grid-cols-2 gap-6">
        <Card className="w-full bg-[#E6D5B8] border-2 border-amber-700 shadow-lg">
          <CardHeader className="border-b border-amber-700">
            ...
            <CardDescription className="text-[#5C4033]">
              Prove your basic mechanic skills
            </CardDescription>
          </CardHeader>
          <CardContent className="pt-6">
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                <Badge
                  variant="secondary"
                  className="bg-[#D2B48C] text-amber-700 border border-amber-700"
                >
                  10 Questions
                </Badge>
                <Badge
              ...
              <p className="text-sm text-[#5C4033]">
                Complete this test to verify your standard mechanic skills and
                unlock the advanced test.
              </p>
            </div>
          </CardContent>
          <CardFooter>
        ...
        <Card className="w-full bg-[#E6D5B8] border-2 border-amber-700 shadow-lg opacity-80">
          <CardHeader className="border-b border-amber-700">
            ...
            <CardDescription className="text-[#5C4033]">
              Prove your advanced mechanic skills
            </CardDescription>
          </CardHeader>
          <CardContent className="pt-6">
            <div className="space-y-4">
              ...
              <p className="text-sm text-[#5C4033]">
                This test will be available after passing the Standard Mechanic
                Test.
              </p>
            </div>
          </CardContent>
          <CardFooter>
            <Button
              className="w-full bg-[#A9A9A9] text-[#F8F3E6] cursor-not-allowed"
              disabled
            >
              Locked
            </Button>
